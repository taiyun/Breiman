...
\section{PROJECTS IN CONSULTING}
...
\subsection{The Chlorine Project}
...
\subsection{Perceptions on Statistical Analysis}
...
\section{RETURN TO THE UNIVERSITY}
...
\section{THE USE OF DATA MODELS}
...
\subsection{Problems in Current Data Modeling}
...
\subsection{The Multiplicity of Data Models}
...
\section{THE LIMITATIONS OF DATA MODELS}
...
\subsection{A New Research Community}
...
\subsection{Theory in Algorithmic Modeling}
...
\section{RASHOMON AND THE MULTIPLICITY OF GOOD MODELS}
...
\section{OCCAM AND SIMPLICITY VS. ACCURACY}
...
\subsection{Growing Forests for Prediction}
...
\subsection{Random Forests are A + Predictors}
...
\section{BELLMAN AND THE CURSE OF DIMINSIONALITY}
...
\subsection{Digging It Out in Small Pieces}
...
\subsection{The Shape Recognition Forest}
...
\section{INFORMATION FROM A BLACK BOX}
...
\subsection{Example I: Variable Importance in a} Survival Data Set
...
\subsection{Example II Clustering in Medical Data}
...
\subsection{Example III: Microarray Data}
...
\subsection{Remarks about the Examples}
